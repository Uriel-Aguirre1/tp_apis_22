...
const moviesController = {
    list: async(req, res) => {
        try{
            ...
            if(!orders.includes(order)){
                throw new Error(`El campo ${order} no existe. Campos admitidos : ['id','title','rating','awards','release_date']`)
            };
        ...
        throw new Error('upps, no hay pelis')
    ...
    detail: async (req, res) => {
        ...
        try{
            ...
            throw new Error('uuu la peli no existe')
        }catch (error){
        console.log(error);
    ...
    newest: async (req, res) => {
        try{
            ...
            throw new Error('uuu no hay pelicula')
